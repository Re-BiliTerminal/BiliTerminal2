        ...
        get() {
            ...
            return if (isRoundDevice()) {
                PaddingValues(
                    ...
                    end = maxOf(PaddingDefaults.horizontalContentPadding(), safeContentPadding.calculateRightPadding(LayoutDirection.Ltr)),
                    bottom = maxOf(PaddingDefaults.verticalContentPadding(), safeContentPadding.calculateBottomPadding())
                )
            } else {
                safeContentPadding
            }
