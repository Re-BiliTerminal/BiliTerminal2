...
import com.huanli233.bilizepam.ui.dialog.app.AlertDialog
import com.huanli233.bilizepam.ui.dialog.app.MaterialAlertDialogBuilder
...
object Dialogs {
    ...
    fun Context.dialogBuilder() = if (LocalData.settings.theme.fullScreenDialogDisabled) {
        AppMaterialDialogBuilder(this, R.style.Theme_BiliZepam_Material3_AlertDialog)
    } else {
        AppMaterialDialogBuilder(this, R.style.Theme_BiliZepam_Material3_AlertDialog_FullScreen)
    }
