...
import com.huanli233.biliterminal2.adapter.viewpager.ViewPagerImageAdapter;
import com.huanli233.biliterminal2.ui.widget.PhotoViewpager;
        ...
        for (int i = 0; i < imageList.size(); i++) {
            ...
            try {
                Glide.with(this).asDrawable()
                        .load(GlideUtil.urlHq(imageList.get(i)))  //让b站自己压缩一下以加速获取
