package com.huanli233.biliterminal2.util.network;
...
import com.huanli233.biliterminal2.util.SSLSocketFactoryCompat;
...
public class NetWorkUtil {
    ...
    private static void saveCookiesFromResponse(Response response) {
        ...
        String cookiesStr = Preferences.getString(Preferences.COOKIES, "");
        ...
        if (setCookies.length() >= 2) {
            Preferences.putString(Preferences.COOKIES, setCookies.substring(0, setCookies.length() - 2));
            refreshHeaders();
        }
    }
    ...
    public static void putCookie(String key, String val) {
        synchronized (NetWorkUtil.class) {
            Cookies cookies = new Cookies(Preferences.getString(Preferences.COOKIES, ""));
            cookies.set(key, val);
            Preferences.putString(Preferences.COOKIES, cookies.toString());
        }
    }
    ...
    public static Cookies getCookies() {
        synchronized (NetWorkUtil.class) {
            return new Cookies(Preferences.getString(Preferences.COOKIES, ""));
        }
    }
    ...
    public static final ArrayList<String> webHeaders = new ArrayList<>() {{
        add("Cookie");
        add(Preferences.getString(Preferences.COOKIES, ""));
        add("Referer");
    ...
    public static void refreshHeaders() {
        webHeaders.set(1, Preferences.getString(Preferences.COOKIES, ""));
    }
