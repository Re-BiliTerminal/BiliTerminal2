...
package com.huanli233.biliterminal2.ui.widget.snackbar;
...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
  ...
  // Delete this once custom Robolectric shadows no longer depend on this method being present
        ...
        (SnackbarContentLayout)
            inflater.inflate(
                hasSnackbarContentStyleAttrs(context)
                    ? com.huanli233.biliterminal2.R.layout.widget_mtrl_snackbar_include
                    : com.huanli233.biliterminal2.R.layout.widget_design_snackbar_include,
                parent,
                false);
